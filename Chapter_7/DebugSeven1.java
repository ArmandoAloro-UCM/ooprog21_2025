...
public class DebugSeven1
{
    public static void main(String[] args)
    {
        ...
        name1 = kb.nextLine(); // FIXED: Added parentheses to call nextLine() method
        System.out.print("Second name >> ");
        name2 = kb.nextLine(); // FIXED: Added parentheses to call nextLine() method
        System.out.print("Third name >> ");
        name3 = kb.nextLine(); // FIXED: Added parentheses to call nextLine() method
