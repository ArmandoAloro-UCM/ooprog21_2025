...
public class DebugFour4
{
    public static void main(String args[])
    {
        ...
        DebugTrip trip1;
        DebugTrip trip2;
        DebugTrip trip3; // Changed from duplicate "DebugTrip trip2;" to "DebugTrip trip3;"
        ...
        display(trip2);
        display(trip3);
        input.close(); // Added for good practice
    }
    public static void display(DebugTrip trip)
    {
        System.out.println("Going to " + trip.getDestination());
        System.out.println("Leaving from " + trip.getDepartureCity()); // Changed from "trp.getDepartureCity()" to "trip.getDepartureCity()"
